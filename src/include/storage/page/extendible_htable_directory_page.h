...
class ExtendibleHTableDirectoryPage {
 public:
   ...
   */
  auto GetGlobalDepthMask() const -> uint32_t { return (1U << global_depth_) - 1; };
   ...
   */
  auto GetLocalDepthMask(uint32_t bucket_idx) const -> uint32_t { return (1U << local_depths_[bucket_idx]) - 1; };
